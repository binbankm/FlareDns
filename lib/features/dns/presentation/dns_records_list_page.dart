                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: InkWell(
                            onTap: () {
                              context.push('/zone/${widget.zoneId}/dns/form', extra: record);
                            },
                            child: Padding(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          if (['A', 'AAAA', 'CNAME'].contains(record.type))
                                            SizedBox(
                                              height: 20,
                                              child: Switch(
                                                ...
                                                onChanged: (val) {
                                                  ref.read(dnsMutationProvider).toggleProxied(widget.zoneId, record, val).catchError((e) {
                                                    if (context.mounted) {
                                            ...
                                            child: IconButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (confirm == true && context.mounted) {
                                                  try {
                                                    await ref.read(dnsMutationProvider).deleteRecord(widget.zoneId, record.id);
                                                  } catch (e) {
                                                    if (context.mounted) {
                                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error: $e')));
                                                    }
              ...
              error: (error, stack) => Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    ElevatedButton(
                      onPressed: () => ref.invalidate(dnsRecordsProvider(widget.zoneId)),
